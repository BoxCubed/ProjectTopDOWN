...
public class MenuState implements Screen {
	...
	private void initButton(GameState loadedInstance) {
		...
		clickButton = new MenuButton(startGlyph, font, Gdx.graphics.getWidth() / 2 - startGlyph.width / 2,
				Gdx.graphics.getHeight() / 2, new MenuListener() {
					@Override
		...
		multiplayerButton = new MenuButton(multiGlyph, font, Gdx.graphics.getWidth() / 2 - multiGlyph.width / 2,
				Gdx.graphics.getHeight() / 2 - 100, new MenuListener() {
