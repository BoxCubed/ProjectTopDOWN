...
public class Car extends InputAdapter {
	...
	/** @return the {@link #chassis} */
	public Body getChassis() {
		return chassis;
	}

	/** @return the {@link #leftWheel} */
	public Body getLeftWheel() {
		return leftWheel;
	}

	/** @return the {@link #rightWheel} */
	public Body getRightWheel() {
		return rightWheel;
	}

	/** @return the {@link #motorSpeed} */
	public float getMotorSpeed() {
		return motorSpeed;
	}

	/** @param motorSpeed the {@link #motorSpeed} to set */
	public void setMotorSpeed(float motorSpeed) {
		this.motorSpeed = motorSpeed;
	}

	/** @return the {@link #leftAxis} */
	public WheelJoint getLeftAxis() {
		return leftAxis;
	}

	/** @return the {@link #rightAxis} */
