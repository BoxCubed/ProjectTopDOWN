...
public class MenuButton {
    ...
    public void setGlyphChosen(GlyphLayout s) {
        this.cf = s;
    }

    public void setGlyphNotChosen(GlyphLayout s) {
        this.f = s;
    }
     ...
     *
     * @return the rectangle the menu button is enclosed in
     */
    ...
    public void setChosenImage(Sprite i) {
        ci = i;
    }
     ...
     */
    public void setCollisionLock(boolean lock) {
        this.lock = lock;
    }
     ...
     *
     * @param number   The order of the button from top down. (Assuming you are using an array so 0 should be the first)
