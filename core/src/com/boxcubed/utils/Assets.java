...
public class Assets extends com.badlogic.gdx.assets.AssetManager{
	public static final String nineMMGunSOUND="sounds/9_mm_gunshot.mp3",gunSOUND="sounds/gunshot.mp3",ZAttackSOUND="sounds/zombie_attack.mp3",
