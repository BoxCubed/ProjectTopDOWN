			...
			try {
				...
				try {
					if (recieved instanceof StringPacket && ((StringPacket) recieved).s.startsWith("disconnect:")) {
						...
						// TopDown.instance.setScreen(new
						// MenuState(GameState.instance));
						break;
					}
					if (!(recieved instanceof StringPacket))
					...
					/*
					 * player2.multiPos=universalLerpToPos(player2.getPos(),
					 * packet.loc2); player2.setRotation(packet.rotation);
					 */
					// System.out.println(packet);
				} catch (NullPointerException e) {
					/* TODO handle unknown instance */}
