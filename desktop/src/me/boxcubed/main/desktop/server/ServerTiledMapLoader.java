...
public class ServerTiledMapLoader extends BaseTmxMapLoader<ServerTiledMapLoader.Parameters> {
	 ...
	 * 
	 * @param resolver */
	public ServerTiledMapLoader (FileHandleResolver resolver) {
		super(resolver);
	}
	...
	public TiledMap load (String fileName) {
		return load(fileName, new ServerTiledMapLoader.Parameters());
	}
	...
	@Override
	public void loadAsync (AssetManager manager, String fileName, FileHandle tmxFile, ServerTiledMapLoader.Parameters parameter) {
		map = null;
	...
	@Override
	public TiledMap loadSync (AssetManager manager, String fileName, FileHandle file, ServerTiledMapLoader.Parameters parameter) {
		return map;
	}
